...
import { useMagicQuery } from 'swr-rxmodel/use-magic-query';
...
import useLayzyMagicPost from 'swr-rxmodel/use-layzy-magic-post';
import { MagicPostBuilder } from 'swr-rxmodel/magic-post-builder';
